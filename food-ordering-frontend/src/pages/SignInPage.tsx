...
const testAccounts = {
  ...
  "restaurant-owner": { email: "test@owner.com", password: "12345678" },
  "admin": { email: "test@admin.com", password: "12345678" },
};
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="restaurant-owner">Restaurant Owner (test@owner.com)</SelectItem>
              <SelectItem value="admin">Admin (test@admin.com)</SelectItem>
              {selectedRole && (
